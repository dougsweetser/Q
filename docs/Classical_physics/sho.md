...
\(0,x double dot + k x/m, 0, 0\) = 0](../img/Classical_physics/sho/s_gr_1.gif)

This equation can be solved directly.

![x = C\(2\) cosine \(the square root of k over m times t\) + C\(1\) sine
\(the square root of k over m times t\)](../img/Classical_physics/sho/s_gr_2.gif)
...
square root of k over m times t\)\)](../img/Classical_physics/sho/s_gr_3.gif)
...
b x, 0, 0\) + \(0, k x over m,0,0\) =](../img/Classical_physics/sho/s_gr_4.gif)

![= \(0, x double dot + b x dot + k x over m, 0, 0\) = 0](../img/Classical_physics/sho/s_gr_5.gif)
...
over 2 times t ](../img/Classical_physics/sho/s_gr_6.gif)
...
=](../img/Classical_physics/sho/s_gr_7.gif)

![=\(0, 0, \(-d squared  by d x squared +1/v squared  d squared  by d t
squared \) f\(t v+x\), 2 d squared  f\(t v + x\)/v dt dx\)](../img/Classical_physics/sho/s_gr_8.gif)
