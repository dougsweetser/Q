...
![F =  \(0, - k x, - k y, 0\)](../img/Classical_physics/conservative_force/s_gr_1.gif)
...
0](../img/Classical_physics/conservative_force/s_gr_2.gif)
...
0\)](../img/Classical_physics/conservative_force/s_gr_3.gif)
...
dz\)](../img/Classical_physics/conservative_force/s_gr_4.gif)

![= integral\(k x dx +k y dy, - k x dt + k y dz, - k y dt - k x dz,
0\)](../img/Classical_physics/conservative_force/s_gr_5.gif)

![=\(k x squared  over 2 + k y squared  over 2, -k t x + k y z, - k t y - k x
z, 0\)](../img/Classical_physics/conservative_force/s_gr_6.gif)

![\(d by dt,Del\) acting on \(k x squared  over 2 + k y squared  over 2, 0\) =
\(0, - k x, - k y, 0\)](../img/Classical_physics/conservative_force/s_gr_7.gif)
...
0\)](../img/Classical_physics/conservative_force/s_gr_8.gif)

![integral from 0 to 2 pi F dt = 0](../img/Classical_physics/conservative_force/s_gr_9.gif)
...
0\)](../img/Classical_physics/conservative_force/s_gr_10.gif)

![integral from 0 to 2 pi along path 1 F dt = - 2 k r squared
](../img/Classical_physics/conservative_force/s_gr_11.gif)

![path 2 = \(0, - t r + r, t r, 0\)](../img/Classical_physics/conservative_force/s_gr_12.gif)

![integral from 0 to 2 pi along path 1 F dt = - 2 k r squared
](../img/Classical_physics/conservative_force/s_gr_13.gif)
