...
V\)](../img/QM/uncertainty_principle/s_gr_1.gif)
...
![q = e to the \(a b I\) ](../img/QM/uncertainty_principle/s_gr_2.gif)

![where  q conjugate times q = 1,   a b = s over root q conjugated times q,  I
= V over root V conjugated times V](../img/QM/uncertainty_principle/s_gr_3.gif)
...
![A hat acts on q = A times q](../img/QM/uncertainty_principle/s_gr_4.gif)
...
a](../img/QM/uncertainty_principle/s_gr_9.gif)

![= -a I d q by  d a + a I d q by d a  +  I q d a by d a = I
q](../img/QM/uncertainty_principle/s_gr_10.gif)
...
a](../img/QM/uncertainty_principle/s_gr_11.gif)
...
q\)](../img/QM/uncertainty_principle/s_gr_15.gif)
...
prime](../img/QM/uncertainty_principle/s_gr_16.gif)
...
prime q =](../img/QM/uncertainty_principle/s_gr_17.gif)
...
](../img/QM/uncertainty_principle/s_gr_18.gif)
...
squared q](../img/QM/uncertainty_principle/s_gr_19.gif)
...
B](../img/QM/uncertainty_principle/s_gr_20.gif)
...
![bra vector: |psi> maps to q](../img/QM/uncertainty_principle/s_gr_21.gif)

![ket vector: <psi| maps to q
conjugated](../img/QM/uncertainty_principle/s_gr_22.gif)

![operator: A maps to A](../img/QM/uncertainty_principle/s_gr_23.gif)

![imaginary: i maps to 3-vector I](../img/QM/uncertainty_principle/s_gr_24.gif)

![commutator: \[A, B\] maps to \[A,
B\]](../img/QM/uncertainty_principle/s_gr_25.gif)

![norm: <psi|psi> maps to q conjugated times
q](../img/QM/uncertainty_principle/s_gr_26.gif)

![expectation of A: <psi|A psi> maps to q conjugated A
q](../img/QM/uncertainty_principle/s_gr_27.gif)

![A is Hermitian maps to \(0, A\) is anti-
Hermitian](../img/QM/uncertainty_principle/s_gr_28.gif)

![The square of the standard deviation: dA squared = <psi | A squared  psi> -
<psi| A psi> squared maps to  DA squared
](../img/QM/uncertainty_principle/s_gr_29.gif)
...
![A goes to X](../img/QM/uncertainty_principle/s_gr_30.gif)

![B goes to P = i h bar d by dx](../img/QM/uncertainty_principle/s_gr_31.gif)

![I h bar = the commutator of A, B goes to   i h bar the commutator of X,
P](../img/QM/uncertainty_principle/s_gr_32.gif)
...
deviation of P squared ](../img/QM/uncertainty_principle/s_gr_33.gif)
