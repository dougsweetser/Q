...
![the norm of phi squared  = <phi | phi>](../img/QM/bracket_notation/s_gr_1.gif)
...
\(t, X\) conjugated times \(t, X\)](../img/QM/bracket_notation/s_gr_2.gif)
...
0\)](../img/QM/bracket_notation/s_gr_3.gif)
...
fourth](../img/QM/bracket_notation/s_gr_4.gif)
...
\(\(t, X\) - epsilon \(t, X\) over 4\) =](../img/QM/bracket_notation/s_gr_5.gif)

![= \(epsilon to the fourth over 4, 0, 0, 0\) is less than \(epsilon to the
fourth, 0, 0, 0\)](../img/QM/bracket_notation/s_gr_6.gif)
...
=](../img/QM/bracket_notation/s_gr_23.gif)

![\(<\(t, X\) | \(t, X\)> + <\(t prime, X prime\) | \(t prime, X prime\)>\)
squared ](../img/QM/bracket_notation/s_gr_24.gif)
...
psi> times <phi | phi>](../img/QM/bracket_notation/s_gr_25.gif)

Let a third wave function, chi, be the sum of these two with an arbitrary
parameter lambda.

![chi is defined to be psi + lambda phi](../img/QM/bracket_notation/s_gr_26.gif)
...
or equal to zero ](../img/QM/bracket_notation/s_gr_27.gif)
...
phi](../img/QM/bracket_notation/s_gr_28.gif)

![psi conjugated time psi - phi conjugated times psi times psi conjugated
times phi over phi conjugated times phi](../img/QM/bracket_notation/s_gr_29.gif)
...
phi](../img/QM/bracket_notation/s_gr_30.gif)
...
phi>](../img/QM/bracket_notation/s_gr_31.gif)
...
prime\)>](../img/QM/bracket_notation/s_gr_32.gif)

![= \(\(t - t prime\) squared  + \(X-X prime\).\(X-X prime\),
0\)](../img/QM/bracket_notation/s_gr_33.gif)
...
squared  + X prime squared , 0\)](../img/QM/bracket_notation/s_gr_34.gif)

![2 Re <\(t, X\) | \(t prime, X prime\)> <= <\(t, X\) | \(t, X\)> + <\(t
prime, X prime\) | \(t prime, X prime\)>](../img/QM/bracket_notation/s_gr_35.gif)
